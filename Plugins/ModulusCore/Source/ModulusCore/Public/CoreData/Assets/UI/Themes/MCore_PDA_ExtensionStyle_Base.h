 ...
 */
UCLASS(Abstract, Blueprintable, ClassGroup="ModulusCore")
class MODULUSCORE_API UMCore_PDA_ExtensionStyle_Base : public UPrimaryDataAsset
{
	GENERATED_BODY()

public:
	/** Tag under which this style is registered in the parent theme's ExtensionStyles map. */
	UPROPERTY(EditDefaultsOnly, BlueprintReadOnly, Category="ModulusCore|Theme|Extension",
		meta=(Categories="Modulus.Theme.Extension"))
