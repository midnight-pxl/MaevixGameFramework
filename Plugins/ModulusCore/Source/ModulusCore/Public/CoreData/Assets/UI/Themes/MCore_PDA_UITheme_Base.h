...
public:
	...
	UPROPERTY(EditDefaultsOnly, BlueprintReadOnly, Category = "ModulusCore|Theme|CommonUI")
	...
	UPROPERTY(EditDefaultsOnly, BlueprintReadOnly, Category = "ModulusCore|Theme|Styles")
	...
	UPROPERTY(EditDefaultsOnly, BlueprintReadOnly, Category="ModulusCore|Theme|Extensions")
	...
	UFUNCTION(BlueprintPure, Category="ModulusCore|Theme", meta=(DisplayName="Get Extension Style"))
