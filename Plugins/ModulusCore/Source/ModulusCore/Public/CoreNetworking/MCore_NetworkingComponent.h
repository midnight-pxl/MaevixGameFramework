 ...
 * (e.g. Dynomega). See MODULUSCORE_WORK_TRACKER.md T-19.
 *
 ...
 * until Iris graduates from Beta. See MODULUSCORE_WORK_TRACKER.md T-13 (honesty doc) and
...
public:
	...
	UFUNCTION(BlueprintPure, Category="ModulusCore|Networking|Authority")
	 ...
	 * returns false unconditionally. See MODULUSCORE_WORK_TRACKER.md T-13 / T-19.
	 */
	UFUNCTION(BlueprintPure, Category="ModulusCore|Networking|Replication")
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category = "ModulusCore|Replication")
	void ForceNetUpdate();
...
protected:
	...
	{
		UE_LOG(LogModulusNetworking, Warning,
