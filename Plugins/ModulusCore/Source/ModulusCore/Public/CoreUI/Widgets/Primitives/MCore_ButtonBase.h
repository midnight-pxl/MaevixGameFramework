...
public:
	...
	UFUNCTION(BlueprintCallable, Category = "ModulusCore|Button|Text")
	void SetButtonText(const FText& InText);

	UFUNCTION(BlueprintPure, Category = "ModulusCore|Button|Text")
	...
	UFUNCTION(BlueprintCallable, Category = "ModulusCore|Button|Style")
	void SetButtonStyleOverride(TSubclassOf<UCommonButtonStyle> InStyle);

	UFUNCTION(BlueprintPure, Category = "ModulusCore|Button|Style")
	...
	UFUNCTION(BlueprintCallable, Category = "ModulusCore|Button")
	...
	UFUNCTION(BlueprintPure, Category = "ModulusCore|Button")
	...
	UPROPERTY(BlueprintAssignable, Category = "ModulusCore|Button")
...
protected:
	...
	UPROPERTY(EditAnywhere, BlueprintReadOnly, Category = "ModulusCore|Button")
	EMCore_ButtonDisplayMode DisplayMode = EMCore_ButtonDisplayMode::TextOnly;

	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "ModulusCore|Button|Text", meta = (MultiLine = false))
	FText ButtonText;

	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "ModulusCore|Button|Icon")
	TObjectPtr<UTexture2D> ButtonIcon;

	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "ModulusCore|Button|Theme")
	...
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "ModulusCore|Button|Style")
