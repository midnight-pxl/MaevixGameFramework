...
void UMCore_UIExtensionSubsystem::Initialize(FSubsystemCollectionBase& Collection)
{
	...
	UE_LOG(LogMaevixUI, Verbose, TEXT("UIExtensionSubsystem::Initialize: initialized"));
}
...
void UMCore_UIExtensionSubsystem::Deinitialize()
{
	...
	UE_LOG(LogMaevixUI, Verbose, TEXT("UIExtensionSubsystem::Deinitialize: deinitialized"));
