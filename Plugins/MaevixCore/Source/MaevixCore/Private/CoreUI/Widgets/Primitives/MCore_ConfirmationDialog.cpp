	...
	: Super(ObjectInitializer)
{
	...
	ConfirmText = NSLOCTEXT("MaevixCoreUI", "ConfirmDefault", "Confirm");
	CancelText = NSLOCTEXT("MaevixCoreUI", "CancelDefault", "Cancel");
}
...
void UMCore_ConfirmationDialog::NativeOnActivated()
{
	...
	UE_LOG(LogMaevixUI, Log, TEXT("ConfirmationDialog::NativeOnActivated: dialog activated, widget=%s"), *GetNameSafe(this));
}
