...
class MAEVIXCORE_API UMCore_DA_SettingDefinition : public UDataAsset
{
	GENERATED_BODY()
...
public:
	...
	UPROPERTY(EditDefaultsOnly, BlueprintReadOnly, Category = "MaevixCore|Settings|Definition|Toggle",
		meta = (EditCondition = "SettingType == EMCore_SettingType::Toggle",
				EditConditionHides))
	bool DefaultToggleValue{false};

	UPROPERTY(EditDefaultsOnly, BlueprintReadOnly, Category = "MaevixCore|Settings|Definition|Dropdown",
	 ...
	 */
	UPROPERTY(EditAnywhere, BlueprintReadOnly, Category = "MaevixCore|Settings|Definition|Category")
	FName SectionID;
	 ...
	 */
	UPROPERTY(EditDefaultsOnly, BlueprintReadOnly, Category = "MaevixCore|Settings|Definition|Behavior",
