...
namespace MCore_LoadingTags
{
    ...
    MAEVIXCORE_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(MCore_Loading_Context_Startup);

    /* Gameplay-to-gameplay level transitions. */
    MAEVIXCORE_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(MCore_Loading_Context_InGame);

    /* Returning from gameplay to the main menu map. */
    MAEVIXCORE_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(MCore_Loading_Context_MainMenu);
}
