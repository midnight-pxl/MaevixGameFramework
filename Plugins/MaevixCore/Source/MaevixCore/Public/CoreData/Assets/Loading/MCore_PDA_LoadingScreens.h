 ...
 *
 * List one or more in Project Settings > Maevix Core > Loading Screen > Libraries.
...
class MAEVIXCORE_API UMCore_PDA_LoadingScreens : public UPrimaryDataAsset
{
	GENERATED_BODY()

public:
	UPROPERTY(EditAnywhere, BlueprintReadOnly, Category="MaevixCore|Loading|Screens")
