...
public:
	...
	UFUNCTION(BlueprintPure, Category = "MaevixCore|Network",
	...
	UFUNCTION(BlueprintPure, Category = "MaevixCore|Network|Widget",
	...
	UFUNCTION(BlueprintPure, Category = "MaevixCore|Network|Subsystem",
