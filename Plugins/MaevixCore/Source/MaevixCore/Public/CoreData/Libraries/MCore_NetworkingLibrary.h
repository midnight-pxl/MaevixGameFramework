 ...
 */
UCLASS()
class MAEVIXCORE_API UMCore_NetworkingLibrary : public UBlueprintFunctionLibrary
{
	GENERATED_BODY()
...
public:
	...
	UFUNCTION(BlueprintPure, Category = "MaevixCore|Networking",
	...
	UFUNCTION(BlueprintPure, Category = "MaevixCore|Networking|Widget",
	...
	UFUNCTION(BlueprintPure, Category = "MaevixCore|Networking|Subsystem",
