...
class MAEVIXCORE_API UMCore_TabbedContainer : public UCommonUserWidget
{
	GENERATED_BODY()
...
public:
	...
	UFUNCTION(BlueprintPure, Category = "MaevixCore|UI|TabbedContainer")
	...
	UPROPERTY(BlueprintAssignable, Category = "MaevixCore|UI|TabbedContainer|Events")
...
protected:
	...
	UPROPERTY(EditDefaultsOnly, BlueprintReadOnly, Category = "MaevixCore|UI|TabbedContainer")
